...
public:
	...
	void GetEmployers(vector<Employer> employers, string path);//Функция для загрузки списка работников
	...
	void ShowEmployers(vector<Employer> employers);//Вывод работников (логин и пароль)
	void DeleteEmployer(vector<Employer> employers);//Удаление работника по логину
	void DeleteEmployer(vector<Employer> employers,string login);//Удаление работника по логину
	...
	void RewriteEmployers(vector<Employer> employers);//Перезапись файла с работниками при удалении работника
